package com.example.takeimageappevan;
        ...
        if (requestCode== GALLERY){
            if (data !=null){
                ...
                try {
                    ...
                    Toast.makeText(com.example.takeimageappevan.MainActivity.this,"Image Saved !",
                    ...
                    e.printStackTrace();
                    Toast.makeText(com.example.takeimageappevan.MainActivity.this,"Failed!",
                            Toast.LENGTH_SHORT).show();
                }
            }
